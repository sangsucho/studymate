...
|메인 페이지 퍼블리싱|카페 예약, 그룹모집, 메인 및 상세 퍼블리싱|관지자 페이지,faq작성 퍼블리싱|로그인,회원가입,계정찾기 퍼블리싱|포트폴리오 메인 및 상세/faq 페이지 퍼블리싱|마이페이지 퍼블리싱|
|마이페이지 기능 구현|메인/관리자페이지/세션 처리/faq 페이지 기능 구현|스터디 카페 예약 기능 구현|로그인,회원가입,계정 찾기 기능 구현|스터그룹 모집 기능 구현|포트폴리오 기능 구현|
